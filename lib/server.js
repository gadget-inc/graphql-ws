            ...
            socket.onMessage(async function onMessage(data) {
                ...
                switch (message.type) {
                    case common_1.MessageType.ConnectionInit: {
                        ...
                        try {
                            permittedOrPayload = await (onConnect === null || onConnect === void 0 ? void 0 : onConnect(ctx));
                        }
                        catch (err) {
                            return socket.close(common_1.CloseCode.InternalServerError, 'message' in err ? err.message : err);
                        }
